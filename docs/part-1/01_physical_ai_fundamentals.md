...
**Control loop frequency:** Most physical systems operate at 10–1000 Hz cycles per second. This fundamentally constrains algorithm design—you cannot run expensive computations at every cycle.
...
- Image classification (software AI): Can achieve 99 percent plus accuracy on ImageNet; errors are data-science problems
- Visual navigation for a robot (Physical AI): 99 percent accuracy means crashes 1 percent of the time—unacceptable; requires redundancy and safety layers
